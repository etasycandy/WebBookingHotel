...
const ProductDetail = () => {
    ...
    return (
        <div className="ProductDetail container flex-row justify-content-center mt-5">
            <h1 className="text-center">Villa Phú Quốc</h1>
            <div className="ImageShow" style={{ width: "90%", height: "50vh", overflow: "hidden", margin: '0 auto' }}>
